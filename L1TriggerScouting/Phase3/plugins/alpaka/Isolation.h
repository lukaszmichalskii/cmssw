...
class Isolation {
public:
  size_t Isolate(Queue& queue, PuppiCollection const& data) const;
...
private:
  ...
  void Combinatorics(
    ...
    Tc* __restrict__ pions_num, Tc* __restrict__ int_cut_ct, Tc* __restrict__ high_cut_ct, Tc* __restrict__ best_score
  ) const;
};
