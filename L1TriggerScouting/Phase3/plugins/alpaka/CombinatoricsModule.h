 ...
 * @brief Find rare W -> 3 pi decay products based on some constraints
 * 
 ...
 */
class CombinatoricsModule : public stream::EDProducer<> {

public:
  // Constructor & destructor
  CombinatoricsModule(const edm::ParameterSet& params);
  ~CombinatoricsModule() override = default;
