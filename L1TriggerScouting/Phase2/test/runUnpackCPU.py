...
process.load("L1TriggerScouting.Phase2.unpackers_cff_cpu")
...
## Configure unpackers
process.scPhase2PuppiRawToDigiCPUStruct.fedIDs = [*puppiStreamIDs]
process.goodOrbitsByNBX.nbxMin = 3564 * options.timeslices // options.tmuxPeriod
process.goodOrbitsByNBX.unpackers = [ "scPhase2PuppiRawToDigiCPUStruct" ]
...
process.p_inclusive = cms.Path(
  process.scPhase2PuppiRawToDigiCPUStruct +
...
process.scPhase2PuppiRawToDigiCandidate = process.scPhase2PuppiRawToDigiCPUStruct.clone(
    runStructUnpacker = cms.bool(False),
    runCandidateUnpacker = cms.bool(True),
    runInlineVersion = cms.bool(False),
)
process.scPhase2PuppiRawToDigiSOA = process.scPhase2PuppiRawToDigiCPUStruct.clone(
    runStructUnpacker = cms.bool(False),
...
process.scPhase2PuppiRawToDigiCPU = process.scPhase2PuppiRawToDigiCPUStruct.clone(
    runStructUnpacker = cms.bool(False),
    runCandidateUnpacker = cms.bool(True),
    runInlineVersion = cms.bool(False),
    runBatchProcessing = cms.bool(False),
    runSIMDVersion = cms.bool(False),
)

process.scPhase2PuppiRawToDigiInlinedCPU = process.scPhase2PuppiRawToDigiCPUStruct.clone(
    runStructUnpacker = cms.bool(False),
    runCandidateUnpacker = cms.bool(True),
    runInlineVersion = cms.bool(True),
    runBatchProcessing = cms.bool(False),
    runSIMDVersion = cms.bool(False),
)

process.scPhase2PuppiRawToDigiBatchProcessing = process.scPhase2PuppiRawToDigiCPUStruct.clone(
    runStructUnpacker = cms.bool(False),
    runCandidateUnpacker = cms.bool(True),
    runInlineVersion = cms.bool(False),
    runBatchProcessing = cms.bool(True),
    runSIMDVersion = cms.bool(False),
)

process.scPhase2PuppiRawToDigiSIMDBatchProcessing = process.scPhase2PuppiRawToDigiCPUStruct.clone(
    runStructUnpacker = cms.bool(False),
    runCandidateUnpacker = cms.bool(True),
    runInlineVersion = cms.bool(False),
    runBatchProcessing = cms.bool(False),
    runSIMDVersion = cms.bool(True),
)

process.unpack_cpu = cms.Path(
  process.scPhase2PuppiRawToDigiCPU + 
  process.scPhase2PuppiRawToDigiInlinedCPU +
  process.scPhase2PuppiRawToDigiBatchProcessing + 
  process.scPhase2PuppiRawToDigiSIMDBatchProcessing
)
...
process.schedule = cms.Schedule(process.unpack_cpu)
