...
namespace ALPAKA_ACCELERATOR_NAMESPACE::l1sc {
  ...
  void L1TScPhase2PFCandidatesRawToDigi::produce(device::Event &event, const device::EventSetup &event_setup) {
   ...
   * 
   */
  void L1TScPhase2PFCandidatesRawToDigi::fillDescriptions(edm::ConfigurationDescriptions &descriptions) {
   ...
   * 
   */
  void L1TScPhase2PFCandidatesRawToDigi::collectBuffers(const SDSRawDataCollection &raw_data) {
