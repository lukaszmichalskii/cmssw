#ifndef PhysicsTools_PyTorch_interface_TorchModelAot
#define PhysicsTools_PyTorch_interface_TorchModelAot
...
namespace cms::torch {
  ...
  public:
    ...
    explicit TorchModelAot(const std::string &precompiled_lib_path) 
...
#endif  // PhysicsTools_PyTorch_interface_TorchModelAot