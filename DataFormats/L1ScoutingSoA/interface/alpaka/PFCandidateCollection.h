#ifndef DataFormats_L1ScoutingSoA_interface_alpaka_PFCandidateCollection_h
#define DataFormats_L1ScoutingSoA_interface_alpaka_PFCandidateCollection_h
...
namespace ALPAKA_ACCELERATOR_NAMESPACE::l1sc {
  ...
  using PFCandidateCollection = PortableCollection<PFCandidateSoA>;

}  // namespace ALPAKA_ACCELERATOR_NAMESPACE::l1sc

ASSERT_DEVICE_MATCHES_HOST_COLLECTION(l1sc::PFCandidateCollection, l1sc::PFCandidateHostCollection);

#endif  // DataFormats_L1ScoutingSoA_interface_alpaka_PFCandidateCollection_h